...
bg = pygame.image.load(r"C:\Users\INTEKNO-PC4\Desktop\TSIS_7\images\mic.png").convert()
bg_rect = bg.get_rect()
image_left = pygame.image.load(r"C:\Users\INTEKNO-PC4\Desktop\TSIS_7\images\second.png")
left_rect = image_left.get_rect(bottomleft=(415, 565))
image_right = pygame.image.load(r"C:\Users\INTEKNO-PC4\Desktop\TSIS_7\images\minute.png")
